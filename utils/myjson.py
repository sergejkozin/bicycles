...
class MyJson( object ):
	...
	class Parser( object ):
		...
		def __init__( self, jstr ):
			...
			self.jstr 	= MyJson._decode(jstr)	# data in json representation
	...
	def loads( self, jstr ):
		...
		"""
		return MyJson.Parser( jstr ).parse()
